...
function authDocumentation(stack) {
  if (stack.backendKey === 'none') return `# Authentication Flow\n\nNo backend or identity provider is generated. The frontend starts without authentication. If authentication is added later, document session storage, expiry, refresh, logout, recovery, CSRF/CORS boundaries, and server-side authorization here before shipping it.\n`

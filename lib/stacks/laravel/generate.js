...
function apiRoutes(stack) {
  ...
  const middleware = stack.authentication === 'sanctum-spa' ? 'auth:sanctum' : laravelSessionAuthentication.apiMiddleware

...
import { stackRegistry } from './stacks/index.js'
import { collectContributions } from './stacks/shared/contributions.js'
import { buildSpringBootFiles } from '../src/stacks/backends/springboot/create-files.js'
import { buildSharedTestFiles, buildSupabaseProjectFiles, buildSupabaseWebFiles } from '../src/stacks/backends/supabase/create-files.js'
import { augmentSupabaseNativeFiles } from '../src/stacks/backends/supabase/native.js'
import { addPostgresScripts, buildPostgresFiles } from '../src/stacks/backends/postgres/create-files.js'
